...
- Optimize low-level display efficiency
- Note: Users who can use the audio and video plug-in can upgrade. Users who do not support the audio and video plug-in have playback compatibility issues. Subsequent version fixes
