...
<html>
    <head>
        <link rel="stylesheet" href="https://sdk.herewhite.com/white-web-sdk/2.2.10
.css">
        <script src="https://sdk.herewhite.com/white-web-sdk/2.2.10
.js"></script>
...
```shell
# yarn 安装方式
yarn add white-web-sdk@^2.2.10

# 或者使用 npm 安装方式
npm install white-web-sdk@^2.2.10
 --save
